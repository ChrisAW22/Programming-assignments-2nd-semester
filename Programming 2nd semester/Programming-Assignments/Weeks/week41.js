...
console.log("Position of watermelon:", sumArray('watermelon', fruits));
...
console.log("Fruits with names with more than 8 letters:", longFruitCount);
...
function areArrayEqual(arr1, arr2) {
    ...
    let sortedArr1 = arr1slice().sort;
    let sortedArr2 = arr2slice().sort;
...
console.log("Are arrays a and b equal?", areArrayEqual(A, B));
